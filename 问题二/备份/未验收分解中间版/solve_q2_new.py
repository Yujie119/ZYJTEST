...
def main():
    ...
    _,lp_meta=FixedSchedule(data,final['routes']).continuous_bound('C',seconds=5.,seed=202699)
    save_json(OUT/'子问题二'/'连续松弛下界.json',lp_meta)
